...
class KeywordsTypofix(object):
    def __init__(self):
        ...
        self.DATA_STORE = os.path.join(self.TEST_DATA_DIR, "DataStore.xlsx")
    ...
    def data_store_create_list(self):
        ...
        data_store_ls  = data_store.copy_worksheet(data_store["_pattern"])
        data_store_ls.title = self.DATA_STORE_LIST
        data_store.save(os.path.join(self.TEST_DATA_DIR, "DataStore.xlsx"))
    ...
    def data_store_add_item (self, name, value):
        col = 1
        data_store = load_workbook(os.path.join(self.TEST_DATA_DIR, "DataStore.xlsx"))
        ls = data_store[self.DATA_STORE_LIST]
